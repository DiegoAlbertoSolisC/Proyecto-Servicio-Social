...
class LXeMainVolume : public G4PVPlacement
{
  ...
  private:
    ...
    //               G4double x, G4double y, G4double dx, G4double dy,
    //               G4double xmin, G4double ymin, G4int Nx, G4int Ny,
    //               G4double posX, G4double posY, G4double z,
    //               G4int& k);
    //void PlacePMTs(G4LogicalVolume* pmt_log, G4RotationMatrix* rot, G4double& a, G4double& b,
    //               G4double da, G4double db, G4double amin, G4double bmin, G4int na, G4int nb,
    //               G4double& x, G4double& y, G4double& z, G4int& k);
    ...
    G4double fScint_radius;
    G4double fScint_height;
    G4double fHousing_radius;
    G4double fHousing_height;
    G4double fScint_x = 0.;
    G4double fScint_y = 0.;
    G4double fScint_z = 0.;
    G4double housing_z  = 0.;
    G4double fD_mtl = 0.;
    G4int fNx = 0;
    G4int fNy = 0;
    G4int fNz = 0;
    ...
    G4Box* fPmt = nullptr;         // Caja del PMT
    G4Box* fPhotocath = nullptr;   // Caja del fotocatodo
